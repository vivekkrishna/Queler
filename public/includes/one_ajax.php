    ...
    switch ($type) {
        ...
        case 'chat-heads' :
            ...
            if ($chat) {
                ...
                foreach ($chat as $unread) {
                    ...
                    ?>
                    <a href="#me" style="position:fixed; bottom:0; left:<?php echo ($m * 5) + 20; ?>%;"
                       class="open-chat" data-user_id="<?php echo $unread->sender; ?>"><img
                                src="<?php echo $dev_profile->get_avatar(); ?>" class="chat-head img-circle pull-left"
                                alt="User Image" style="border:3px solid white; width:50px;margin-left:-55px">
                        <span class="label label-danger pull-left"
                              style="margin-left:-60px"><?php echo $count; ?></span></a>
                    <?php
                    $m++;
                }
            }
        ...
        case 'chat-names' :
            ...
            if ($chat) {
                ...
                echo "<br><li><center style='color:#5e5e5e'>{$lang['index-chat-no_friends']}</center><li>";
            }
            echo '</ul></div>';
        ...
        case 'open-chat' :
            ...
            if ($chat) {
                ...
                foreach ($chat as $msg) {
                    ...
                    ?>
                    <div class="direct-chat-msg <?php if ($msg->sender == $current_user->id) {
                        echo ' right';
                    } ?>">
                        ...
                        <!-- /.direct-chat-info -->
                        <img class="direct-chat-img" src="<?php echo $sender->get_avatar(); ?>"
                             alt="Message User Image"><!-- /.direct-chat-img -->
                        <div class="direct-chat-text <?php if ($msg->sender == $current_user->id) {
                            echo ' bg-blue';
                        } ?>">
                            <?php echo $msg->msg; ?>
                        </div>
                        <?php if ($msg->viewed) { ?><span class="<?php if ($msg->sender == $current_user->id) {
                            echo ' pull-left';
                        } else {
                            echo ' pull-right';
                        } ?> text-aqua" style='font-size:10px'><i class="fa fa-check"></i> Seen</span><?php } ?>
                        <!-- /.direct-chat-text -->
                    </div>
                    <?php
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#chatForm').ajaxForm(function (responseText) {
                        $("#chat-msg").val('');
                        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=open-chat", {
                            id: 1,
                            data: <?php echo $data; ?> ,
                            hash: '<?php echo $hash; ?>'
                        }, function (response) {
                            $('.chat-receptor').html(response);
                            var scrollTo_val = $('.slimscroll2').prop('scrollHeight') + 'px';
                    ...
                    $("#ban-user").click(function () {
                        ...
                        if (confirm("Are you sure you want to ban this user from chatting with you again?")) {
                            $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=ban_user", {
                                id: 1,
                                data: user_id,
                                hash: '<?php echo $hash; ?>'
                            }, function () {
            ...
            if ($found) {
                ...
                if (!$prev_follow) {
                    ...
                    if ($classname == 'User') {
                        ...
                        $str = $lang['notif-user-follow-msg'];
                        $str = str_replace('[NAME]', $current_user->f_name, $str);
                        $str = str_replace('[LINK]', $url_mapper['users/view'] . $current_user->id, $str);
                        $notif_msg = $str;
                        $notif_user = $id;
                        ...
                        $str = $lang['notif-q_f_award-msg'];
                        $str = str_replace('[LINK]', $url_mapper['users/view'] . $current_user->id, $str);
                        $str = str_replace('[Q_LINK]', $url_mapper['questions/view'] . $url_type, $str);
                        $str = str_replace('[NAME]', $current_user->f_name, $str);
            ...
            if ($found) {
                ...
                if (!$prev_likes) {
                    ...
                    if ($classname == 'Question') {
                        ...
                        $receiver = User::get_specific_id($found->user_id);
                        $str = $lang['notif-a_l_award'];
                        $str = str_replace('[LINK]', $url_mapper['users/view'] . $current_user->id, $str);
                        $str = str_replace('[Q_LINK]', $url_mapper['questions/view'] . $url_type . "#answer-{$found->id}", $str);
                        $str = str_replace('[NAME]', $current_user->f_name, $str);
                        $award = Award::send_award($found->user_id, "{$str} , {$lang['notif-award']} <b>1</b> {$lang['notif-point']}");
                        $receiver->award_points(1);
        ...
        case 'approve' :
            ...
            if ($found) {
                ...
                if ($classname == 'Question') {
                    ...
                    $str = str_replace('[TITLE]', $found->title, $str);
                    $notif_msg = $str;
                    $notif_user = $found->user_id;
                    $notif = Notif::send_notification($notif_user, $notif_msg, $notif_link);
        ...
        case 'approve-report' :
            ...
            if ($found) {
                ...
                if ($classname == 'Question') {
                    ...
                    $str = $lang['notif-report-q_reporter-approve-msg'];
                    $str = str_replace('[TITLE]', "<a href='{$notif_link}'>" . $found->title . "</a>", $str);
                    //$str = str_replace('[CONTENT]' , strip_tags($found->content), $str);
                    $notif_msg = $str;
                    ...
                    $str = $lang['notif-report-a_publisher-approve-msg'];
                    $str = str_replace('[TITLE]', "<a href='{$notif_link}'>" . $q->title . "</a>", $str);
                    //$str = str_replace('[CONTENT]' , strip_tags($found->content), $str);
                    $notif_msg = $str;
                    $notif_user = $found->user_id;
                    $notif = Notif::send_notification($notif_user, $notif_msg, $notif_link);
                    ...
                    $str = $lang['notif-report-a_reporter-approve-msg'];
                    $str = str_replace('[TITLE]', "<a href='{$notif_link}'>" . $q->title . "</a>", $str);
                    //$str = str_replace('[CONTENT]' , strip_tags($found->content), $str);
                    $notif_msg = $str;
                    $notif_user = $report->user_id;
        ...
        case 'reject-report' :
            ...
            if ($found) {
                ...
                if ($classname == 'Question') {
                    ...
                    $notif_link = $url_mapper['questions/view'] . $url_type;
                    $str = $lang['notif-report-q_reporter-reject-msg'];
                    $str = str_replace('[TITLE]', "<a href='{$notif_link}'>" . $found->title . "</a>", $str);
                    $notif_msg = $str;
                    $notif_user = $report->user_id;
                    $notif = Notif::send_notification($notif_user, $notif_msg, $notif_link);
        ...
        case 'index_posts' :
            ...
            if ($questions) {
                foreach ($questions as $q) {
                    ...
                    <?php if ($q->answers) { ?>
                        <!-- Modal -->
                        <div class="modal fade in" id="q-<?php echo $q->id; ?>-sneak" tabindex="-1" role="dialog"
                             aria-hidden="true">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <small><img src="<?php echo $quser_avatar; ?>" class="img-circle"
                                            ...
                                            Question asked by <?php if ($q->anonymous) {
                                                ...
                                                </b><?php } ?> , Posted <?php echo date_ago($q->created_at); ?></small>
                                        </small>
...
//foreach($answers as $a) {
                                            ...
                                            <?php if ($current_user->can_see_this('questions.interact', $group)) { ?>
                                                <div class="btn-group question-like-machine">
                                                    ...
                                                    <a href="#me" class="btn btn-default <?php echo $downvote_class; ?>"
                                                       ...
                                                       data-obj="answer" data-lbl="<?php echo $lang['btn-dislike']; ?>"
                                                       data-lbl-active="<?php echo $lang['btn-disliked']; ?>"><i
                                                                class="fa fa-thumbs-o-down"></i> <?php echo $downvote_txt; ?>
                ...
                <h3 style="color:#b0b0b0">
                    <center><i class="fa fa-edit"></i><br><?php echo $lang['index-question-no_questions']; ?><br><br>
                        <small>
