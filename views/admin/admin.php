        ...
        <div class="row">
                ...
                <ul class="feed-ul ">
                    <?php if ($current_user->can_see_this('dashboard.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#dashboard"
                               class="col-md-12"><?php echo $lang['admin-section-dashboard']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('general_settings.update', $group)) { ?>
                        <li><a data-toggle="tab" href="#general"
                               class="col-md-12"><?php echo $lang['admin-section-general']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('pending.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#pending"
                               class="col-md-12"><?php echo $lang['admin-section-pending'] . ' ' . $pending_posts_badge; ?></a>
                        </li><?php } ?>
                    <?php if ($current_user->can_see_this('pending.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#reports"
                               class="col-md-12"><?php echo $lang['admin-section-reports'] . ' ' . $pending_reports_badge; ?></a>
                        </li><?php } ?>
                    <?php if ($current_user->can_see_this('adminusers.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#users"
                               class="col-md-12"><?php echo $lang['admin-section-users']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('groups.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#groups"
                               class="col-md-12"><?php echo $lang['admin-section-groups']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('pages.update', $group)) { ?>
                        <li><a data-toggle="tab" href="#pages"
                               class="col-md-12"><?php echo $lang['admin-section-pages']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('admintopics.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#topics"
                               class="col-md-12"><?php echo $lang['admin-section-topics']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('admanager.read', $group)) { ?>
                        <li><a data-toggle="tab" href="#admanager"
                               class="col-md-12"><?php echo $lang['admin-section-admanager']; ?></a></li><?php } ?>
                    <?php if ($current_user->can_see_this('profanity_filter.update', $group)) { ?>
                        <li><a data-toggle="tab" href="#profanity_filter"
                               class="col-md-12"><?php echo $lang['admin-section-filter']; ?></a></li><?php } ?>
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content">
                    ...
                    <?php if ($current_user->can_see_this('dashboard.read', $group)) { ?>
                        <div id="dashboard" class="tab-pane fade in <?php if ($section == 'dashboard') {
                            echo 'active';
                        } ?>">
                            <h3 class="page-header"><?php echo $lang['admin-hello']; ?>
                                , <?php echo $current_user->f_name; ?>!</h3>


                            <p style="font-size:16px"><?php $str = $lang['admin-dashboard-users'];
                                $str = str_replace('[COUNT]', User::count_everything(' AND id != 1000 AND deleted = 0 '), $str);
                                echo $str; ?></p>
                            ...
                            <p style="font-size:16px"><?php $str = $lang['admin-dashboard-questions'];
                                $str = str_replace('[COUNT]', Question::count_everything(), $str);
                                echo $str; ?></p>
                            ...
                            <p style="font-size:16px"><?php $str = $lang['admin-dashboard-answers'];
                                $str = str_replace('[COUNT]', Answer::count_everything(), $str);
                                echo $str; ?></p>
                    ...
                    <?php }
                    if ($current_user->can_see_this('pages.update', $group)) { ?>
                        <div id="pages" class="tab-pane fade in <?php if ($section == 'pages') {
                            echo 'active';
                        } ?>">
                            <form method="post" action="<?php echo $url_mapper['admin/']; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#about-us"
                                                              href="#me"><?php echo $lang['pages-about-title']; ?></a>
                                        </li>
                                        <li><a data-toggle="tab" href="#contact-us"
                                               href="#me"><?php echo $lang['pages-contact-title']; ?></a></li>
                                        <li><a data-toggle="tab" href="#privacy-policy"
                                               href="#me"><?php echo $lang['pages-privacy-title']; ?></a></li>
                                        <li><a data-toggle="tab" href="#terms"
                                               href="#me"><?php echo $lang['pages-terms-title']; ?></a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="about-us" class="tab-pane fade in active">
                                            <br>
                                            <textarea class="summernote"
                                                      name="about-us"><?php echo $about_us->value; ?></textarea>
                                            <br><br>
                                        </div>
                                        <div id="contact-us" class="tab-pane fade ">
                                            <br>
                                            <textarea class="summernote"
                                                      name="contact-us"><?php echo $contact_us->value; ?></textarea>
                                            <hr>
                                            <div class="form-group">
                                                <label for="msg"><?php echo $lang['admin-pages-about-email']; ?></label>
                                                <input type="email" class="form-control" name="contact-us-msg" id="msg"
                                                       placeholder="" value="<?php echo $contact_us->msg; ?>">
                                            </div>
                                            <br><br>
                                        </div>
                                        <div id="privacy-policy" class="tab-pane fade ">
                                            <br>
                                            <textarea class="summernote"
                                                      name="privacy-policy"><?php echo $privacy_policy->value; ?></textarea>
                                            <br><br>
                                        </div>
                                        <div id="terms" class="tab-pane fade ">
                                            <br>
                                            <textarea class="summernote"
                                                      name="terms"><?php echo $terms->value; ?></textarea>
                                            <br><br>
                                        </div>
                                    </div>
                                ...
                                <center>
                                    <input class="btn btn-success" type="submit" name="edit_pages"
                    ...
                    <?php if ($current_user->can_see_this('profanity_filter.update', $group)) { ?>
                        <div id="profanity_filter" class="tab-pane fade in <?php if ($section == 'profanity_filter') {
                            echo 'active';
                        } ?>">
                            <form method="post" action="<?php echo $url_mapper['admin/']; ?>">
                                ...
                                <div class="row">
                                    <textarea name="filter" class="form-control"
                                              rows="15"><?php echo $profanity_filter->value; ?></textarea>
                                </div>
                                <br><br>
                                <center>
                                    <input class="btn btn-success" type="submit" name="edit_profanity_filter"
                                           value="<?php echo $lang['btn-submit']; ?>">
                                </center>
                    ...
                    <?php if ($current_user->can_see_this('general_settings.update', $group)) { ?>
                        <div id="general" class="tab-pane fade in <?php if ($section == 'general') {
                            echo 'active';
                        } ?>">
                            <form method="post" action="<?php echo $url_mapper['admin/']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4>
                                            <center><?php echo $lang['admin-general-site-title']; ?></center>
                                        </h4>
                                        <br>
                                        <div class="form-group">
                                            ...
                                            if (!empty($settings['site_logo'])) {
                                                ...
                                                ?>
                                                <img src="<?php echo WEB_LINK . "public/" . $file->image_path(); ?>"
                                                     class='img-responsive'/><br>
                                                <div class='col-xs-6'><input type='checkbox' name='change_logo'
                                                                             value='1'> Change Logo
                                                </div>
                                                <div class='col-xs-6'><input type='checkbox' name='delete_logo'
                                                                             value='1'> Delete Logo
                                                </div><br><br>
                                                <?php
                                            } else {
                                            ...
                                            <small>Max. Width: 140px, Max. Height: 30px</small>
                                            <br/>
                                            <br>
                                            ...
                                            <input type="text" class="form-control" name="site_keywords"
                                                   id="site_keywords" value="<?php echo $settings['site_keywords']; ?>"
                                                   placeholder="Keywords.." required>
                                            <br>

                                            <?php $langs = scandir(LIBRARY_PATH . '/lang/');
                                            unset($langs[0]);
                                            unset($langs[1]);
                                            unset($langs[2]); ?>

                                            <label for="site_lang"><?php echo $lang['admin-general-site-lang']; ?></label>&nbsp;&nbsp;
                                            <select id="site_lang" name="site_lang" class="form-control select2"
                                                    style="width:200px" data-placeholder="Site Language..">
                                                <?php foreach ($langs as $l) {
                                                    $l = explode('.', $l);
                                                    echo "<option value='{$l[1]}' ";
                                                    if ($l[1] == $settings['site_lang']) {
                                                        echo ' selected';
                                                    }
                                                    echo " >{$l[1]}</option>";
                                                } ?>
                                            ...
                                            <select id="site_status" name="site_status" class="form-control select2"
                                                    style="width:200px" data-placeholder="Site Status..">
                                                <option value="1" <?php if ($settings['site_status'] == '1') {
                                                    echo ' selected';
                                                } ?>>Active
                                                </option>
                                                <option value="0" <?php if ($settings['site_status'] == '0') {
                                                    echo ' selected';
                                                } ?>>Closed
                                                </option>
                                            </select><br><br>
                                            <label for="closure_msg"><?php echo $lang['admin-general-site-status_msg']; ?></label>
                                            <input type="text" class="form-control" name="closure_msg" id="closure_msg"
                                                   value="<?php echo $settings['closure_msg']; ?>"
                                                   placeholder="Site Closed Message..">
                                        </div>
                                        <hr>
                                        <h4>
                                            <center><?php echo $lang['admin-general-url-title']; ?></center>
                                        </h4>
                                        <br>
                                        <div class="form-group">
                                            <label for="url_type"><?php echo $lang['admin-general-url-type']; ?></label>&nbsp;&nbsp;
                                            <select id="url_type" name="url_type" class="form-control select2"
                                                    style="width:200px" data-placeholder="URL Type..">
                                                <option value="slug" <?php if ($settings['url_type'] == 'slug') {
                                                    echo ' selected';
                                                } ?>>By Subject/Slug
                                                </option>
                                                <option value="id" <?php if ($settings['url_type'] == 'id') {
                                                    echo ' selected';
                                                } ?>>By ID
                                                </option>
                                            </select><br><br>
                                    ...
                                    <div class="col-md-6">
                                        <h4>
                                            <center><?php echo $lang['admin-general-posting-title']; ?></center>
                                        </h4>
                                        <br>
                                        <div class="form-group">
                                            <label for="q_modal"><?php echo $lang['admin-general-posting-q_modal']; ?></label>&nbsp;&nbsp;
                                            <select id="q_modal" name="q_modal" class="form-control select2"
                                                    style="width:200px">
                                                <option value="1" <?php if (isset($settings['q_modal']) && $settings['q_modal'] == '1') {
                                                    echo ' selected';
                                                } ?> >Enable
                                                </option>
                                                <option value="0" <?php if (isset($settings['q_modal']) && $settings['q_modal'] == '0') {
                                                    echo ' selected';
                                                } ?>>Disable
                                                </option>
                                            </select><br><br>
                                            ...
                                            <select id="q_approval" name="q_approval" class="form-control select2"
                                                    style="width:200px">
                                                <option value="0" <?php if ($settings['q_approval'] == '0') {
                                                    echo ' selected';
                                                } ?> >Immediately
                                                </option>
                                                <option value="1" <?php if ($settings['q_approval'] == '1') {
                                                    echo ' selected';
                                            ...
                                            <select id="a_approval" name="a_approval" class="form-control select2"
                                                    style="width:200px">
                                                <option value="0" <?php if ($settings['a_approval'] == '0') {
                                                    echo ' selected';
                                                } ?>>Immediately
                                                </option>
                                                <option value="1" <?php if ($settings['a_approval'] == '1') {
                                                    echo ' selected';
                                                } ?> >After Admin Approval
                                                </option>
                                            </select><br><br>
                                        ...
                                        <br><br>
                                        <h4>
                                            <center><?php echo $lang['admin-general-access-title']; ?></center>
                                        </h4>
                                        <br>
                                        <div class="form-group">
                                            <label for="public_access"><?php echo $lang['admin-general-access-login']; ?></label>&nbsp;&nbsp;
                                            <select id="public_access" name="public_access" class="form-control select2"
                                                    style="width:200px">
                                                <option value="0" <?php if ($settings['public_access'] == '0') {
                                                    echo ' selected';
                                                } ?>>Disabled
                                                </option>
                                                <option value="1" <?php if ($settings['public_access'] == '1') {
                                                    echo ' selected';
                                                } ?> >Enabled
                                                </option>
                                            </select><br><br>
                                        ...
                                        <br><br>
                                        <h4>
                                            <center><?php echo $lang['admin-general-reg-title']; ?></center>
                                        </h4>
                                        <br>
                                        <div class="form-group">
                                            <label for="reg_group"><?php echo $lang['admin-general-reg-group']; ?></label>&nbsp;&nbsp;
                                            <select id="reg_group" name="reg_group" class="form-control select2"
                                                    style="width:200px">
                                                <?php
                                                $groups = Group::get_users();
                                                foreach ($groups as $g) {
                                                    echo "<option value='{$g->id}' ";
                                                    if ($g->id == $settings['reg_group']) {
                                                        echo ' selected';
                                                    }
                                                    echo " >{$g->name}</option>";
                                                }
                                        ...
                                        <br><br>
                                        <h4>
                                            <center><?php echo $lang['admin-general-chat-title']; ?></center>
                                        </h4>
                                        <br>
                                        <div class="form-group">
                                            <label for="chat_status"><?php echo $lang['admin-general-chat-msg']; ?></label>&nbsp;&nbsp;
                                            <select id="chat_status" name="chat_status" class="form-control select2"
                                                    style="width:200px">
                                                <option value="on" <?php if ($chat->value == 'on') {
                                                    echo ' selected';
                                                } ?> >Enable Chat
                                                </option>
                                                <option value="off" <?php if ($chat->value == 'off') {
                                                    echo ' selected';
                                                } ?>>Disable Chat
                                                </option>
                                            </select><br><br>
                                ...
                                <center>
                                    <input class="btn btn-success" type="submit" name="update_settings"
                                           value="<?php echo $lang['btn-submit']; ?>">
                                </center>
                    ...
                    <?php } ?>
                    <?php if ($current_user->can_see_this('pending.read', $group)) { ?>
                        <div id="pending" class="tab-pane fade <?php if ($section == 'pending') {
                            echo ' in active';
                        } ?>">
                            ...
                            <form method="post" action="<?php echo $url_mapper['admin/']; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4>
                                            <center><?php echo $lang['admin-pending-questions']; ?></center>
                                        </h4>
                                        <br>
                                        <?php $pending_q = Question::get_pending(); ?>
                                        <?php if ($pending_q) { ?>
                                            <table class="custom_table table table-striped table-bordered"
                                                ...
                                                <tbody><?php foreach ($pending_q as $pq) {
                                                    $pq_user = User::get_specific_id($pq->user_id);
                                                    if (URLTYPE == 'slug') {
                                                        $url_type = $pq->slug;
                                                    } else {
                                                        $url_type = $pq->id;
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><a href="<?php echo $url_mapper['questions/view'];
                                                            echo $url_type; ?>"
                                                               target="_blank"><?php echo $pq->title; ?></a></td>
                                                        <td><a href="<?php echo $url_mapper['users/view'];
                                                            echo $pq_user->id . '/'; ?>"
                                                               target="_blank"><?php echo $pq_user->f_name . " " . $pq_user->l_name . "</a><br><small style='font-size:10px; color:grey'>" . date_ago($pq->created_at) . "</small>"; ?>
                                                        </td>
                                                        <td>
                                                            <p class="btn-group approve-machine"><a href="#me"
                                                                                                    class="btn btn-default btn-sm approve-item"
                                                                                                    data-obj="question"
                                                                                                    data-id="<?php echo $pq->id; ?>"
                                                                                                    data-action="approve"><i
                                                                            class="fa fa-check"></i></a>
                                                                <a href="#me"
                                                                   class="btn btn-default  btn-sm reject-item"
                                                                   data-obj="question" data-id="<?php echo $pq->id; ?>"
                                                                   data-action="reject"><i class="fa fa-times"></i></a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                    ...
                                    <div class="col-md-6">
                                        <h4>
                                            <center><?php echo $lang['admin-pending-answers']; ?></center>
                                        </h4>
                                        <br>
                                        ...
                                        <?php if ($pending_q) { ?>
                                            <table class="custom_table table table-striped table-bordered"
                                                ...
                                                <tbody><?php foreach ($pending_q as $pa) {
                                                    $pa_user = User::get_specific_id($pa->user_id);
                                                    ...
                                                    <tr>
                                                        <td><a href="<?php echo $url_mapper['questions/view'];
                                                            echo $url_type;
                                                            echo "#answer-" . $pa->id; ?>"
                                                               target="_blank"><?php echo $string; ?></a></td>
                                                        <td><a href="<?php echo $url_mapper['users/view'];
                                                            echo $pa_user->id; ?>/"
                                                               target="_blank"><?php echo $pa_user->f_name . " " . $pa_user->l_name . "</a><br><small style='font-size:10px; color:grey'>" . date_ago($pa->created_at) . "</small>"; ?>
                                                        </td>
                                                        <td>
                                                            <p class="btn-group approve-machine"><a href="#me"
                                                                                                    class="btn btn-default btn-sm approve-item"
                                                                                                    data-obj="answer"
                                                                                                    data-id="<?php echo $pa->id; ?>"
                                                                                                    data-action="approve"><i
                                                                            class="fa fa-check"></i></a>
                                                                <a href="#me"
                                                                   class="btn btn-default  btn-sm reject-item"
                                                                   data-obj="answer" data-id="<?php echo $pa->id; ?>"
                                                                   data-action="reject"><i class="fa fa-times"></i></a>
                                                            </p>
                                                        </td>
                                                    </tr>
                        ...
                        <div id="reports" class="tab-pane fade <?php if ($section == 'reports') {
                            echo ' in active';
                        } ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php if ($reports) { ?>
                                            <table class="custom_table table table-striped table-bordered"
                                                ...
                                                <tbody><?php foreach ($reports as $r) {
                                                    $pq_user = User::get_specific_id($r->user_id);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo $link; ?>"
                                                               target="_blank"><?php echo $title; ?></a></td>
                                                        <td><a href="<?php echo $url_mapper['users/view'];
                                                            echo $pq_user->id . '/'; ?>"
                                                               target="_blank"><?php echo $pq_user->f_name . " " . $pq_user->l_name . "</a><br><small style='font-size:10px; color:grey'>" . date_ago($pq->created_at) . "</small>"; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <p class="btn-group approve-machine">
                                                                <a href="#me"
                                                                   class="btn btn-default btn-sm approve-report-item"
                                                                   data-obj="<?php echo $r->obj_type; ?>"
                                                                   data-id="<?php echo $pq->id; ?>"
                                                                   data-action="approve_report"
                                                                   data-report_id="<?php echo $r->id; ?>"><?php echo $lang['admin-reports-approve_report']; ?></a>
                                                                <a href="#me"
                                                                   class="btn btn-default  btn-sm reject-report-item"
                                                                   data-obj="<?php echo $r->obj_type; ?>"
                                                                   data-id="<?php echo $pq->id; ?>"
                                                                   data-action="reject_report"
                                                                   data-report_id="<?php echo $r->id; ?>"><?php echo $lang['admin-reports-reject_report']; ?></a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <?php $i++;
                    ...
                    <?php } ?>
                    <?php if ($current_user->can_see_this('adminusers.read', $group)) { ?>
                        <div id="users" class="tab-pane fade <?php if ($section == 'users') {
                            echo 'in active';
                        } ?>">
                            <h3><?php echo $lang['admin-users-title']; ?>

                                <?php if ($section == 'users' && isset($_GET['type']) && $_GET['type'] != '') { ?>
                                    <a href="<?php echo $url_mapper['admin/']; ?>/&section=users"
                                       class="btn btn-sm btn-primary"><i
                                                class="fa fa-arrow-<?php echo $lang['direction-left']; ?>"></i>&nbsp;<?php echo $lang['btn-back']; ?>
                                    </a>
                                <?php } ?>
                            </h3>
                            ...
                            <?php } elseif ($section == 'users' && isset($_GET['type']) && $_GET['type'] == 'edit' && isset($_GET['id']) && is_numeric($_GET['id']) && isset($_GET['hash'])) {
                                ...
                                <form method="post" action="<?php echo $url_mapper['admin/']; ?>/"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="mobile" id="mobile"
                                                       placeholder="Phone.." value="<?php echo $user->mobile; ?>">
                                                <br>
                                            ...
                                            <?php if ($current_user->can_see_this('adminusers.power', $group)) { ?>
                                                <div class="form-group" <?php if ($user->id == '1') {
                                                    echo " style='display:none' ";
                                                } ?>>
                                                    <label for="prvlg_group"><?php echo $lang['admin-users-group']; ?></label>&nbsp;&nbsp;
                                                    <select id="prvlg_group" name="prvlg_group" class="form-control"
                                                            style="width:200px" <?php if ($user->id == '1') {
                                                        echo ' readonly';
                                                    } ?> >
                                                        <?php
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label class="control-label"
                                                       for="img1_upl"><?php echo $lang['admin-users-avatar']; ?></label>
                                                <div class="controls">

                                                    <img src="<?php echo $quser_avatar; ?>"
                                                         class="img-polaroid img-circle"
                                                         style="float:<?php echo $lang['direction-left']; ?>; padding:5px; margin-<?php echo $lang['direction-right']; ?>:10px; width:64px; height:64px"
                                                         id="img1">
                                                    <div style="height:64px; padding-top: 12px;width:200px;float:<?php echo $lang['direction-left']; ?>">
                                                        <input class="text-input " type="file" name="upload_files[]"
                                                               id="img1_upl"/><br/>
                                                    </div>
                                                ...
                                                <label for="username"
                                                       class="control-label"><?php echo $lang['admin-users-username']; ?></label>

                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">@</span>
                                                    <input type="text" class="form-control " id="username"
                                                           name="username" placeholder=""
                                                           value="<?php echo $user->username; ?>" <?php if (!$current_user->can_see_this('adminusers.changeusername', $group)) { ?> disabled readonly <?php } ?> >
                                                </div>
                                                ...
                                                <?php if ($current_user->can_see_this('adminusers.changemail', $group)) { ?>
                                                    <label for="username"
                                                           class="control-label"><?php echo $lang['admin-users-email']; ?></label>
                                                    <div class="controls"><input type="email" class="form-control "
                                                                                 id="username" name="email"
                                                                                 placeholder="Unchanged"></div>
                                                <?php } ?>
                                                <?php if ($current_user->can_see_this('adminusers.suspend', $group)) { ?>
                                                    <br>
                                                    <label><input type="checkbox" data-checkbox="form-control" value="1"
                                                                  name="disabled" <?php if ($user->disabled == '1') {
                                                            echo ' checked';
                                                        } ?>> <?php echo $lang['admin-users-suspend']; ?></label>
                                                <?php } ?>
                                                ...
                                                <?php if ($current_user->can_see_this('adminusers.changepass', $group)) { ?>
                                                    <label for="password"
                                                           class="control-label"><?php echo $lang['admin-users-pass']; ?></label>
                                    ...
                                    <center>
                                        <input class="btn btn-success" type="submit" name="edit_user"
                                               value="<?php echo $lang['btn-submit']; ?>">
                                    </center>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo $lang['admin-users-f_name']; ?></th>
                                        <th><?php echo $lang['admin-users-group']; ?></th>
                                        <th><?php echo $lang['admin-users-phone']; ?></th>
                                        <th><?php echo $lang['admin-users-email']; ?></th>
                                        <th><?php echo $lang['admin-users-questions']; ?></th>
                                        <th><?php echo $lang['admin-users-answers']; ?></th>
                                    ...
                                    foreach ($all_obj as $obj) :
                                        ...
                                        <tr <?php if ($obj->disabled) {
                                            ...
                                            <td>
                                                <div class="btn-group"><?php echo $pic . $edit . $delete; ?></div>
                                            </td>
                                            ...
                                            if (isset($obj->avatar) && $obj->avatar) {
                                                ...
                                                <div class="modal fade modal-image"
                                                     id="modal-image-<?php echo $obj->id; ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <img src="<?php echo $link; ?>" alt="picture 1"
                    ...
                    <?php if ($current_user->can_see_this('admintopics.read', $group)) { ?>
                        <div id="topics" class="tab-pane fade <?php if ($section == 'topics') {
                            echo 'in active';
                        } ?>">
                            <h3><?php echo $lang['admin-topics-title']; ?>
                                ...
                                if (isset($_GET['ref']) && $_GET['ref'] != '') {
                                    $back = $url_mapper['feed/'] . "{$_GET['ref']}/";
                                }
                                ?>
                                <?php if ($section == 'topics' && isset($_GET['type']) && $_GET['type'] != '') { ?>
                                    <a href="<?php echo $back; ?>" class="btn btn-sm btn-primary"><i
                                                class="fa fa-arrow-<?php echo $lang['direction-left']; ?>"></i>&nbsp;<?php echo $lang['btn-back']; ?>
                                    </a>
                                <?php } else { ?>
                                    <a href="<?php echo $add; ?>" class="btn btn-sm btn-danger"><i
                                                class="fa fa-plus"></i>&nbsp;<?php echo $lang['btn-add']; ?></a>
                                <?php } ?>
                            </h3>
                            <hr>
                            ...
                            <?php if ($section == 'topics' && isset($_GET['type']) && $_GET['type'] == 'new') {
                                ...
                                <form method="post" action="<?php echo $url_mapper['admin/']; ?>/"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name"
                                                       placeholder="Topic Name.." required value="">
                                                <br>
                                                <label class="control-label"
                                                       for="img1_upl"><?php echo $lang['admin-topics-avatar']; ?></label>
                                                <div class="controls">

                                                    <img src="<?php echo WEB_LINK . 'public/img/topic.png'; ?>"
                                                         class="img-polaroid img-circle"
                                                         style="float:<?php echo $lang['direction-left']; ?>; padding:5px; margin-<?php echo $lang['direction-right']; ?>:10px; width:64px; height:64px"
                                                         id="img1">
                                                    <div style="height:64px; padding-top: 12px;width:200px;float:<?php echo $lang['direction-left']; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows='5' name="description"
                                                          id="description" placeholder="Topic Description.."></textarea>
                                                <br>
                                    ...
                                    <center>
                                        <input class="btn btn-success" type="submit" name="add_topic"
                                               value="<?php echo $lang['btn-submit']; ?>">
                                    </center>
                            ...
                            <?php } elseif ($section == 'topics' && isset($_GET['type']) && $_GET['type'] == 'edit' && isset($_GET['id']) && is_numeric($_GET['id']) && isset($_GET['hash'])) {
                                ...
                                <form method="post" action="<?php echo $url_mapper['admin/']; ?>/"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows='5' name="description"
                                                          id="description"
                                                          placeholder="Topic Description.."><?php echo strip_tags($topic->description); ?></textarea>
                                                <br>
                                    ...
                                    <center>
                                        <input class="btn btn-success" type="submit" name="edit_topic"
                                               value="<?php echo $lang['btn-submit']; ?>">
                                    </center>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        <th style='width:10px'>#</th>
                                        <th><?php echo $lang['admin-topics-name']; ?></th>
                                        <th><?php echo $lang['admin-topics-description']; ?></th>
                                        <th style='width:150px'><i class="fa fa-wrench"></i></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <?php } ?>
                    <?php if ($current_user->can_see_this('admanager.read', $group)) { ?>
                        <div id="admanager" class="tab-pane fade <?php if ($section == 'admanager') {
                            echo 'in active';
                        } ?>">
                            ...
                            <form method="post" action="<?php echo $url_mapper['admin/']; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#between-q"
                                                              href="#me"><?php echo $lang['admin-admanager-between_q']; ?></a>
                                        </li>
                                        <li><a data-toggle="tab" href="#between-a"
                                               href="#me"><?php echo $lang['admin-admanager-between_a']; ?></a></li>
                                        <li><a data-toggle="tab" href="#lt-sidebar"
                                               href="#me"><?php echo $lang['admin-admanager-lt_sidebar']; ?></a></li>
                                        <li><a data-toggle="tab" href="#rt-sidebar"
                                               href="#me"><?php echo $lang['admin-admanager-rt_sidebar']; ?></a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="between-q" class="tab-pane fade in active">
                                            <br>
                                            <p>Adblock Type:
                                            <div class="btn-group"><a href="#me" class="toggle-code btn btn-default "><i
                                                            class='fa fa-desktop'></i> Other</a>
                                                <a href="#me" class="untoggle-code btn btn-default active"><i
                                                            class='fa fa-code'></i> Google Adsense</a></div>
                                            </p>

                                            <textarea class="custom-summernote form-control" name="between-q" rows="5"
                                                      placeholder=""><?php echo $admanager1->value; ?></textarea>
                                            <br><br>
                                        </div>
                                        <div id="between-a" class="tab-pane fade in ">
                                            <br>
                                            <p>Adblock Type:
                                            <div class="btn-group"><a href="#me"
                                                                      class="toggle-code2 btn btn-default "><i
                                                            class='fa fa-desktop'></i> Other</a>
                                                <a href="#me" class="untoggle-code2 btn btn-default active"><i
                                                            class='fa fa-code'></i> Google Adsense</a></div>
                                            </p>

                                            <textarea class="custom-summernote2 form-control" name="between-a"
                                                      rows="5"><?php echo $admanager1->msg; ?></textarea>
                                            <br><br>
                                        </div>
                                        <div id="lt-sidebar" class="tab-pane fade in ">
                                            ...
                                            <p>Adblock Type:
                                            <div class="btn-group"><a href="#me"
                                                                      class="toggle-code3 btn btn-default "><i
                                                            class='fa fa-desktop'></i> Other</a>
                                                <a href="#me" class="untoggle-code3 btn btn-default active"><i
                                                            class='fa fa-code'></i> Google Adsense</a></div>
                                            </p>

                                            <textarea class="custom-summernote3 form-control" name="lt-sidebar"
                                                      rows="5"><?php echo $admanager2->value; ?></textarea>
                                            <br><br>
                                        </div>
                                        <div id="rt-sidebar" class="tab-pane fade in ">
                                            ...
                                            <p>Adblock Type:
                                            <div class="btn-group"><a href="#me"
                                                                      class="toggle-code4 btn btn-default "><i
                                                            class='fa fa-desktop'></i> Other</a>
                                                <a href="#me" class="untoggle-code4 btn btn-default active"><i
                                                            class='fa fa-code'></i> Google Adsense</a></div>
                                            </p>

                                            <textarea class="custom-summernote4 form-control" name="rt-sidebar"
                                                      rows="5"><?php echo $admanager2->msg; ?></textarea>
                                            <br><br>
                                        </div>
                                ...
                                <center>
                                    <input class="btn btn-success" type="submit" name="edit_adblocks"
                                           value="<?php echo $lang['btn-submit']; ?>">
                                </center>
                    ...
                    <?php } ?>
                    <?php if ($current_user->can_see_this('groups.read', $group)) { ?>
                        <div id="groups" class="tab-pane fade <?php if ($section == 'groups') {
                            echo 'in active';
                        } ?>">
                            <h3><?php echo $lang['admin-groups-title']; ?>&nbsp;&nbsp;<a
                                        href='<?php echo $url_mapper['admin/'] . '?section=groups&type=new'; ?>'
                                        class="btn btn-sm btn-primary"><i
                                            class='fa fa-plus'></i> <?php echo $lang['btn-add']; ?></a></h3>
                            ...
                            <?php if ($section == 'groups' && isset($_GET['type']) && $_GET['type'] == 'new') {
                                ...
                                <form id="form-validation" action="user_groups.php" method="post" class="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name"
                                                   class="control-label"><?php echo $lang['admin-groups-name']; ?></label>
                                            <input type="text" class="form-control form-white" id="name" name="name"
                                    ...
                                    <center>
                                        <button class="btn btn-success" name="add_group"
                                                type="submit"><?php echo $lang['btn-submit']; ?></button>
                                        <a href='<?php echo $url_mapper['admin/'] . '?section=groups'; ?>'
                                           class="btn btn-danger"><?php echo $lang['btn-cancel']; ?></a>
                                    </center>
                                ...
                                ?>
                                <form id="form-validation" action="<?php echo $url_mapper['admin/']; ?>" method="post"
                                      class="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name"
                                                   class="control-label"><?php echo $lang['admin-groups-name']; ?></label>
                                            <input type="text" class="form-control form-white" id="name" name="name"
                                                   placeholder="Name" value="<?php echo $this_obj->name; ?>" required>
                                        </div>
                                    </div>
                                    <br><br>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title"><?php
                                                            ...
                                                            if ($current_user->can_see_this($parent_data[0], $this_obj->id)) {
                                                                echo "checked=\"checked\"";
                                                            }
                                                            echo '  value="' . $parent_data[0] . '" />' . $parent_data[1]; ?></h3>
                                                    </div>
                                                    <div class="panel-body">
                                                            ...
                                                            foreach ($section_privileges as $parent => $child) {
                                                                ...
                                                                if (is_array($child) && !empty($child)) {    //Has submenu!
                                                                    ...
                                                                    foreach ($child as $grandchild) {
                                                                        ...
                                                                        if ($current_user->can_see_this($grandchild_data[0], $this_obj->id)) {
                                                                            echo "checked=\"checked\"";
                                                                        }
                                    ...
                                    <center>
                                        <button class="btn btn-success" name="edit_group"
                                                type="submit"><?php echo $lang['btn-submit']; ?></button>
                                        <a href='<?php echo $url_mapper['admin/'] . '?section=groups'; ?>'
                                           class="btn btn-danger"><?php echo $lang['btn-cancel']; ?></a>
                                    </center>
                                ...
                                <table class="table table-hover table-bordered custom_table">
                                    ...
                                    <tr>
                                        <th style='width:10px'>#</th>
                                        <th><?php echo $lang['admin-groups-name']; ?></th>
                                        <th><?php echo $lang['admin-groups-users']; ?></th>
                                        <th style='width:150px'><i class="fa fa-wrench"></i></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    foreach ($all_obj as $obj) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group"><?php echo $edit . " " . $delete; ?></div>
                                            </td>
...
<?php require_once(VIEW_PATH . 'pages/preloader.php'); ?>
    ...
    <script>
        ...
        $('.approve-machine').on('click', '.approve-item', function () {
            ...
            $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=approve", {
                id: id,
                data: $(this).data('obj'),
        ...
        $('.approve-machine').on('click', '.reject-item', function () {
            var id = $(this).data('id');
            $(this).parent().parent().parent().hide();
            $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=reject", {
                id: id,
                data: $(this).data('obj'),
                hash: '<?php echo $random_hash; ?>'
            }, function () {
        ...
        $('.approve-machine').on('click', '.approve-report-item', function () {
            ...
            if (confirm('<?php echo $lang['admin-reports-approve_report-alert']; ?>')) {
                $(this).parent().parent().parent().hide();
                $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=approve-report", {
                    id: id,
                    data: $(this).data('obj'),
        ...
        $('.approve-machine').on('click', '.reject-report-item', function () {
            ...
            if (confirm('<?php echo $lang['admin-reports-reject_report-alert']; ?>')) {
                $(this).parent().parent().parent().hide();
                $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=reject-report", {
                    id: id,
                    data: $(this).data('obj'),
                    report_id: $(this).data('report_id'),
                    hash: '<?php echo $random_hash; ?>'
