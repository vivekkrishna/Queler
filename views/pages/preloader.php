...
<script type="text/javascript">
    ...
    $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=chat-names", {
        id: 1,
        data: 1,
    ...
    $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=chat-heads", {
        id: 1,
        data: 1,
        hash: '<?php echo $random_hash; ?>'
    }, function (response) {
    ...
    setInterval(function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=check_notifications", {
            id: 1,
            data: 1,
            hash: '<?php echo $random_hash; ?>'
        }, function (data) {
