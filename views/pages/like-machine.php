<script type="text/javascript">
    $('.question-like-machine').on('click', '.upvote', function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=like", {
            id: id,
            data: $(this).data('obj'),
    ...
    $('.question-like-machine').on('click', '.undo-upvote', function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=unlike", {
            id: id,
            data: $(this).data('obj'),
            hash: '<?php echo $random_hash; ?>'
        }, function () {
    ...
    $('.question-like-machine').on('click', '.downvote', function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=dislike", {
            id: id,
            data: $(this).data('obj'),
            hash: '<?php echo $random_hash; ?>'
        }, function () {
    ...
    $('.question-like-machine').on('click', '.undo-downvote', function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=undislike", {
            id: id,
            data: $(this).data('obj'),
            hash: '<?php echo $random_hash; ?>'
        }, function () {
    ...
    $('.question-like-machine, .name').on('click', '.follow', function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=follow", {
            id: id,
            data: $(this).data('obj'),
            hash: '<?php echo $random_hash; ?>'
        }, function () {
    ...
    $('.question-like-machine, .name').on('click', '.unfollow', function () {
        ...
        $.post("<?php echo WEB_LINK; ?>public/includes/one_ajax.php?type=unfollow", {
            id: id,
            data: $(this).data('obj'),
            hash: '<?php echo $random_hash; ?>'
        }, function () {
