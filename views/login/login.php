    ...
    try {
        ...
        switch ($e->getCode()) {
            case 0 :
                ...
                break;
            case 1 :
                $msg = "Hybriauth configuration error.";
                break;
            case 2 :
                $msg = "Provider not properly configured.";
                break;
            case 3 :
                $msg = "Unknown or disabled provider.";
                break;
            case 4 :
                $msg = "Missing provider application credentials.";
                break;
            case 5 :
                ...
                break;
            case 6 :
                $msg = "User profile request failed. Most likely the user is not connected "
                    . "to the provider and he should authenticate again.";
                $adapter->logout();
                break;
            case 7 :
                $msg = "User not connected to the provider.";
                $adapter->logout();
                break;
            case 8 :
                $msg = "Provider does not support this feature.";
                break;
        }
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover searchsection">
                <div class="loginbox">
                    <h3 style="color:#b92b27;font-size:45px" class="login-brand">
                        <center><?php echo APPNAME; ?></center>
                    </h3>
                    <p style="font-size:8px">
                    <center> A place to host, participate and enjoy competitions</center>
                    </p>
                    </br>
                    <div class="row">
                        <?php
                        ...
                        <div class="col-md-6 horizontal-separator">
                            <div id="social-login">
                                <?php //if (isset($google_api) && isset($google_api['id']) && $google_api['id'] != ''  ) { ?>
                                <a href="<?php echo $url_mapper['login/']; ?>&provider=facebook"
                                   class="btn btn-primary btn-lg btn-block"><?php echo $lang['login-using_facebook']; ?></a><?php //} ?>
                                <?php //if (isset($facebook_api) && isset($facebook_api['id']) && $facebook_api['id'] != ''  ) { ?>
                                <a href="<?php echo $url_mapper['login/']; ?>&provider=google"
                                   class="btn btn-danger btn-lg btn-block"><?php echo $lang['login-using_google']; ?></a><?php //} ?>
                                <br>

                                <?php echo $lang['login-register'];
                                if ($settings['public_access'] == '1') {
                                    echo '<br>' . $lang['login-as_guest'];
                                } ?>
                                ...
                                <form method="POST" action="<?php echo $url_mapper['login/']; ?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="first_name"
                                                       class="control-label"><?php echo $lang['login-register-f_name']; ?></label>
                                                <input type="text" class="form-control " id="first_name"
                                                       name="first_name" placeholder="" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="last_name"
                                                       class="control-label"><?php echo $lang['login-register-l_name']; ?></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="reg-email"
                                                       class="control-label"><?php echo $lang['login-register-email']; ?></label>
                                                <input type="email" class="form-control " id="reg-email"
                                                       name="reg-email" placeholder="" value="" required>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control " id="reg-username"
                                                           name="reg-username" placeholder="English, No Spaces allowed"
                                                           value="" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="reg-password"
                                                       class="control-label"><?php echo $lang['login-register-pass']; ?></label>
                                                <input type="password" class="form-control " id="reg-password"
                                                       name="reg-password" placeholder="" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="g-recaptcha"
                                                 data-sitekey="<?php echo $captcha_info['sitekey']; ?>"></div>
                                            <input type="checkbox" name="terms"
                                                   required> <?php echo $lang['login-register-terms']; ?>
                                        </div>
                                    </div>
                                    <br>
                                    <input class="btn btn-primary" type="submit" name="register-account"
                                           value="<?php echo $lang['btn-register']; ?>" style='z-index=10001'>
                                    <a href="#me" id="cancel-register"
                        ...
                        <div class="col-md-6 ">
                                ...
                                <form method="POST" action="<?php echo $url_mapper['login/']; ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control " id="email" name="email" placeholder=""
                                               value="" required>
                                        <input type="checkbox"
                                               name="remember-me"> <?php echo $lang['login-remember']; ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="password"
                                               class="control-label"><?php echo $lang['login-register-pass']; ?></label>
                                        <input type="password" class="form-control " id="password" name="password"
                                               placeholder="" value="" required>
                                        <a href="#me" id="forgot-password"
                                           style="color:grey"><?php echo $lang['login-forgot_pass']; ?></a>
                                    </div>
                                    <input class="btn btn-primary" type="submit" name="enterlogin"
                                           value="<?php echo $lang['btn-login']; ?>">
                                    <?php
                                    echo "<input type=\"hidden\" name=\"loginhash\" value=\"" . $random_hash . "\" readonly/>";
                                    ?>
                                </form>
                            ...
                            <div id="forgot-password-block" style="display:none">
                                ...
                                <form method="POST" action="<?php echo $url_mapper['login/']; ?>">
                                    ...
                                    <a href="#me" id="back-to-login"
                                       class="btn btn-primary"><?php echo $lang['btn-back']; ?></a>&nbsp;
                                    <input class="btn btn-primary" type="submit" name="forgotpassword"
                                           value="<?php echo $lang['btn-reset_pass']; ?>">
                                    <?php
                                    echo "<input type=\"hidden\" name=\"loginhash\" value=\"" . $random_hash . "\" readonly/>";
                                    ?>
                                </form>
