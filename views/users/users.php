...
if (isset($_POST['delete_user'])) {
    ...
    if ($_POST['hash'] == $_SESSION[$elhash]) {
        ...
        if ($edited_entry->update()) {
            ...
            $str = $lang['user-farewell'];
            $str = str_replace('[NAME]', $edited_entry->f_name, $str);
            $str = str_replace('[EMAIL]', $contact->msg, $str);
            $msg = $str;
            $_SESSION = array();
...
?>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2 ">
                <center><img src="<?php echo $quser_avatar; ?>" class="img-circle"
                             style="float:<?php echo $lang['direction-left']; ?>;width:90%;margin-<?php echo $lang['direction-right']; ?>:10px">
                </center>
                ...
                <hr>
                <ul class="feed-ul">
                    <li><a href="<?php echo $url_mapper['users/view'];
                        echo $user->id; ?>/?section=questions"
                           class="col-md-12"><?php echo $lang['user-questions']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['users/view'];
                        echo $user->id; ?>/?section=answers" class="col-md-12"><?php echo $lang['user-answers']; ?></a>
                    </li>
                    <li><a href="<?php echo $url_mapper['users/view'];
                        echo $user->id; ?>/?section=followed_by"
                           class="col-md-12"><?php echo $lang['user-followed']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['users/view'];
                        echo $user->id; ?>/?section=following"
                           class="col-md-12"><?php echo $lang['user-following']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['users/view'];
                        echo $user->id; ?>/?section=points" class="col-md-12"><?php echo $lang['user-points']; ?>
                            (<?php echo $user->points; ?>)</a></li>
                </ul>
            ...
            <div class="col-md-8">
                ...
                <div class="publisher" style="margin-top:20px">
                    ...
                    if ($user->id != $current_user->id && $current_user->can_see_this('users.follow', $group)) {
                        ...
                        ?>
                        <p class="name"><a href="#me" class="btn btn-sm btn-default <?php echo $u_follow_class; ?>"
                                           name="<?php echo $user->id; ?>" value="<?php echo $user->follows; ?>"
                ...
                if ($section == 'questions') {
                        ...
                        foreach ($questions as $q) {
                            ...
                            if ($q->anonymous == "0" || $q->anonymous == '1' && $current_user->id == $q->user_id) {
                                ...
                                <div class="question-element">
                                    <?php if ($q->anonymous == '1' && $current_user->id == $q->user_id) { ?>
                                        <small><i><?php echo $lang['user-anonymous-intro']; ?></i></small><?php } ?>
                                    <p class="title"><a href="<?php echo $url_mapper['questions/view'];
                                        echo $url_type; ?>"><?php echo strip_tags($q->title); ?></a></p>
                                    <p class="publisher">
                                    ...
                                    <p class="name">
                                        <?php if ($q->anonymous) {
                                            ...
                                            <?php echo $user->f_name . " " . $user->l_name; ?> <span
                                                    style="color:grey"><?php echo $user->username; ?></span>
                                        <?php } ?>
                                        <br>
                                        <small>@<?php echo $user->username; ?>
                                            | <?php if ($q->updated_at != "0000-00-00 00:00:00") {
                                    ...
                                    <?php if ($current_user->can_see_this('questions.interact', $group)) { ?><p
                                        ...
                                        <a href="<?php echo $url_mapper['questions/view'] . $url_type; ?>#answer-question"
                                        ...
                                        <a href="#me" class="btn btn-default <?php echo $downvote_class; ?>"
                                           ...
                                           data-obj="question" data-lbl="<?php echo $lang['btn-dislike']; ?>"
                        ...
                        foreach ($answers as $a) {
                            ...
                            <div class="question-element">
                                ...
                                <p class="name">
                                    <small>@<?php echo $user->username; ?>
                                        | <?php if ($a->updated_at != "0000-00-00 00:00:00") {
                                            echo $lang['index-questions-updated'] . date_ago($a->updated_at);
                                        } else {
                                ...
                                <div class="btn-group question-like-machine">
                                    ...
                                    <a href="<?php echo "{$url_mapper['questions/view']}{$url_type}#answer-{$a->id}"; ?>"
                                       class="btn btn-sm btn-default" target="_blank"><i class="fa fa-search"></i></a>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu"
                                            ...
                                            <?php if ($a->published == 0 && $current_user->prvlg_group == '1') { ?>
                                                <li>
                                            ...
                                            <li><a href="#me"
                                                   onClick="return confirm('Are you sure you want to report this answer?');"><?php echo $lang['questions-answer-report']; ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    if ($following) {
                        foreach ($following as $f) {
                            ...
                            ?>
                            <div class="question-element"
                                 style="float:<?php echo $lang['direction-left']; ?>; width:33%">
                                <img src="<?php echo $quser_avatar; ?>" class="img-circle"
                                     style="float:<?php echo $lang['direction-left']; ?>;width:46px;margin-<?php echo $lang['direction-right']; ?>:10px">
                                <p class="name">
                                    <b><a href="<?php echo $url_mapper['users/view'] . $u->id; ?>/"><?php echo $u->f_name . " " . $u->l_name; ?></a></b>&nbsp;&nbsp;
                                    <?php if ($current_user->id != $u->id && $current_user->can_see_this('users.follow', $group)) { ?>
                                        <a href="#me" class="btn btn-sm btn-default <?php echo $u_follow_class; ?>"
                                           name="<?php echo $u->id; ?>" value="<?php echo $u->follows; ?>"
                                           data-obj="user" data-lbl="" data-lbl-active="" ><i
                                                class="fa fa-user-plus"></i><?php echo $follow_txt; ?>
                                        | <?php echo $u->follows; ?></a><?php } ?>
                                    <br>
                    ...
                    ?>
                    <form method="post" action="<?php echo $url_mapper['users/view'] . $user->id; ?>/"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="f_name" id="f_name"
                                           placeholder="First Name.." required value="<?php echo $user->f_name; ?>">
                                    <br>

                                    <label for="l_name"><?php echo $lang['admin-users-l_name']; ?></label>
                                    <input type="text" class="form-control" name="l_name" id="l_name"
                                           placeholder="Last Name.." required value="<?php echo $user->l_name; ?>">
                                    <br>
                                    ...
                                    <div class="controls">
                                        ...
                                        <div><img src="<?php echo $quser_avatar; ?>" class=""
                                                  style="float:<?php echo $lang['direction-left']; ?>; padding:5px; margin-<?php echo $lang['direction-right']; ?>:10px; max-width:100%; height:350px"
                                                  id="img1"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="comment" id="comment"
                                           placeholder="Short Description.." value="<?php echo $user->comment; ?>">
                                    <br>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control " id="username" name="username"
                                           placeholder="" value="<?php echo $user->username; ?>" readonly disabled>
                                </div>
                                <br>
                                ...
                                <?php if ($current_user->can_see_this('users.changemail', $group)) { ?>
                                    ...
                                    <div class="controls"><input type="email" class="form-control " id="username"
                                                                 name="email" placeholder="Unchanged"></div>
                                    <br>
                                <?php } ?>
                                ...
                                <?php if ($current_user->can_see_this('users.changepass', $group)) { ?>
                                    ...
                                    <div class="controls"><input type="text" class="form-control " id="password"
                                                                 name="password" placeholder="Unchanged"></div>
                                ...
                                foreach ($notifications as $notif) {
                                    ...
                                    if ($user->can_receive_this($notif)) {
                                        echo ' checked';
                                    }
                        ...
                        <center>
                            <input class="btn btn-success" type="submit" name="edit_user"
                                   value="<?php echo $lang['btn-update']; ?>">
                        </center>
                    ...
                    <form method="post" action="<?php echo $url_mapper['users/view'] . $user->id; ?>/"
                          enctype="multipart/form-data">
                        <center>
                            <input class="btn btn-danger" type="submit" name="delete_user"
                                   value="<?php echo $lang['btn-close_account']; ?>">
                            <a href="<?php echo $url_mapper['users/view'] . $user->id; ?>/"
                               class="btn btn-default"><?php echo $lang['btn-back']; ?></a>
                        </center>
                    ...
                    <table class="table custom-table">
                        ...
                        <tr>
                            ...
                            <th><?php echo $lang['user-points-reason']; ?></th>
                            <th><?php echo $lang['user-points-awarded_at']; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
            ...
            <?php if ($current_user->id != '1000' && $current_user->id == $user->id) { ?>
                <div class="col-md-2">
                    ...
                    <hr>
                    <ul class="feed-ul">
                        <?php if ($current_user->can_see_this('users.update', $group)) { ?>
                            <li>
                            <a href="<?php echo $url_mapper['users/view'] . $user->id . '/?section=edit&hash=' . $random_hash; ?>"
                               class="col-md-12"><?php echo $lang['user-account-edit']; ?></a></li><?php } ?>
                        <?php if ($current_user->can_see_this('users.delete', $group)) { ?>
                            <li>
                            <a href="<?php echo $url_mapper['users/view'] . $user->id . '/?section=delete&hash=' . $random_hash; ?>"
                               class="col-md-12"><?php echo $lang['user-account-delete']; ?></a></li><?php } ?>
                        <li><a href="<?php echo $url_mapper['logout/']; ?>"
                               class="col-md-12"><?php echo $lang['index-user-logout']; ?></a></li>
                    </ul>

                    <?php if (isset($admanager2->msg) && $admanager2->msg != '' && $admanager2->msg != '&nbsp;') {
                        echo "<br style='clear:both'><hr>" . str_replace('\\', '', $admanager2->msg) . "<br style='clear:both'>";
                    } else {
            ...
            <?php } else { ?>
                <div class="col-md-2">
                    <?php if (isset($admanager2->msg) && $admanager2->msg != '' && $admanager2->msg != '&nbsp;') {
                        echo str_replace('\\', '', $admanager2->msg) . "<br style='clear:both'>";
                    } else {
                        echo "<br style='clear:both'><br style='clear:both'><br style='clear:both'>";
                    } ?>
                </div>
