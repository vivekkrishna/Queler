    ...
    switch ($_GET['type']) {
        ...
        case 'approve' :
            ...
            if ($q) {
                ...
                $str = $lang['notif-q_publish-msg'];
                $str = str_replace('[TITLE]', $q->title, $str);
                $notif_msg = $str;
    ...
    if ($_POST['hash'] == $_SESSION[$elhash]) {
        ...
        if (isset($_POST['edit_id'])) {        //edit_comment mode ..
                            ...
                            if ($usrs) {
                                foreach ($usrs as $u) {
                                    ...
                                    if ($u && $u->id != 0 && $u->id != $current_user->id) {
                                        $str = $lang['notif-a_mention-msg'];
                                        $str = str_replace("[NAME]", $current_user->f_name, $str);
                                        $str = str_replace("[TITLE]", $q->title, $str);
            ...
            if ($a->create()) {
                ...
                $str = $lang['notif-a_publish-follow-msg'];
                $str = str_replace("[NAME]", $current_user->f_name, $str);
                $str = str_replace("[TITLE]", $q->title, $str);
                $notif_msg = $str;
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                if (is_array($tags)) {
                    foreach ($tags as $tag) {
                        ?>
                        <a href="<?php echo $url_mapper['feed/'] . $tag; ?>"
                           class="label label-default"><?php echo $tag; ?></a>
                    <?php }
                } ?>
                <?php if ($q->published == 0) { ?><p class="label label-danger"><i
                ...
                <div class="btn-group question-like-machine" role="group" aria-label="question-tools">
                    ...
                    <?php if ($q->user_id != $current_user->id) { ?><a href="#me"
                                                                       class="btn btn-sm btn-default <?php echo $upvote_class; ?>"
                                                                       name="<?php echo $q->id; ?>"
                                                                       value="<?php echo $q->likes; ?>"
                                                                       data-obj="question"
                                                                       data-lbl="<?php echo $lang['btn-like']; ?>"
                                                                       data-lbl-active="<?php echo $lang['btn-liked']; ?>"  >
                        <i class="fa fa-thumbs-o-up"></i> <?php echo $lang['btn-likes']; ?> | <?php echo $q->likes; ?>
                        </a>
                    <a href="#me" class="btn btn-sm btn-default <?php echo $downvote_class; ?>"
                       name="<?php echo $q->id; ?>" value="<?php echo $q->dislikes; ?>" data-obj="question"
                       data-lbl="<?php echo $lang['btn-dislike']; ?>"
                       data-lbl-active="<?php echo $lang['btn-disliked']; ?>"><i
                                class="fa fa-thumbs-o-down"></i> <?php echo $lang['btn-dislikes']; ?>
                        | <?php echo $q->dislikes; ?></a><?php } else { ?>

                        <a href="#me" class="btn btn-sm btn-default disabled"><i
                                    class="fa fa-thumbs-o-up"></i> <?php echo $lang['btn-likes']; ?>
                            | <?php echo $q->likes; ?></a>
                        <a href="#me" class="btn btn-sm btn-default disabled"><i
                                    class="fa fa-thumbs-o-down"></i> <?php echo $lang['btn-likes']; ?>
                            | <?php echo $q->dislikes; ?></a>

                    <?php }
                    if ($current_user->can_see_this("answers.create", $group)) { ?><a href="#me" id="answer-btn"
                                                                                      class="btn btn-sm btn-default"><i
                            class="fa fa-comments"></i> <?php echo $lang['btn-answers']; ?> | <?php echo $q->answers; ?>
                        </a><?php } ?>
                    <a href="#me" class="btn btn-sm btn-default"><i
                                class="fa fa-eye"></i> <?php echo $lang['btn-views']; ?> | <?php echo $q->views; ?></a>


                    <?php if ($q->user_id != $current_user->id) { ?><a href="#me"
                                                                       class="btn btn-sm btn-default <?php echo $q_follow_class; ?>"
                                                                       name="<?php echo $q->id; ?>"
                                                                       value="<?php echo $q->follows; ?>"
                                                                       data-obj="question"
                                                                       data-lbl="<?php echo $lang['btn-follow']; ?>"
                                                                       data-lbl-active="<?php echo $lang['btn-followed']; ?>" >
                        <i class="fa fa-user-plus"></i> <?php echo $follow_txt; ?> | <?php echo $q->follows; ?>
                        </a><?php } else { ?>
                        <a href="#me" class="btn btn-sm btn-default disabled"><i
                                    class="fa fa-user-plus"></i> <?php echo $follow_txt; ?> | <?php echo $q->follows; ?>
                        </a>
                    <?php } ?>
                    ...
                    <div class="btn-group">
                            ...
                            <?php if ($q->user_id == $current_user->id || $current_user->prvlg_group == '1') { ?>
                                <?php if ($q->published == 0) { ?>
                                    <?php if ($current_user->can_see_this('pending.update', $group)) { ?>
                                        <li>
                                            <a href="<?php echo $url_mapper['questions/approve'] . $url_type . "&id={$q->id}&hash={$random_hash}"; ?>"><?php echo $lang['questions-approve']; ?></a>
                                        </li>
                                        <li role="separator" class="divider"></li>
                                    <?php } ?>
                                <?php } ?>

                                <?php if ($current_user->can_see_this('questions.update', $group)) { ?>
                                    <li>
                                    <a href="<?php echo $url_mapper['questions/update'] . $url_type . "&hash={$random_hash}"; ?>"><?php echo $lang['questions-edit']; ?></a>
                                    </li><?php } ?>
                                <?php if ($current_user->can_see_this('questions.delete', $group)) { ?>
                                    <li>
                                    <a href="<?php echo $url_mapper['questions/delete'] . $url_type . "&hash={$random_hash}"; ?>"
                                       onClick="return confirm('Are you sure you want to delete this question?');"><?php echo $lang['questions-delete']; ?></a>
                                    </li><?php } ?>
                                <li role="separator" class="divider"></li>
                            <?php } ?>
                            <?php $reported = Report::check_for_obj('question', $q->id, $current_user->id); ?>
                            <?php if (!$reported) { ?>
                                <li><a href="#report-q" data-toggle="modal"><?php echo $lang['questions-report']; ?></a>
                                </li>
                            <?php } else { ?>
                        ...
                        <?php if (!$reported) { ?>
                            <!-- Modal -->
                            <div class="modal fade in" id="report-q" tabindex="-1" role="dialog"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"
                                                id="exampleModalLabel"><?php echo $lang['questions-report']; ?></h5>
                                        </div>
                                        <form action="<?php echo $url_mapper['questions/view'];
                                        echo $url_type; ?>" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <div class="flag_reasons clearfix">
                                                        ...
                                                        foreach ($reasons as $reason) {
                                                            ...
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" name="info" id="optionsRadios1"
                                                                           value="<?php echo $reason; ?>">
                                                                    <b><?php echo $line[0]; ?>:</b> <span
                                                                            class="light_gray"><?php echo $line[1]; ?></span>
                                                                </label>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                        data-dismiss="modal"><?php echo $lang['btn-cancel']; ?></button>
                                                <button type="submit" name="submit_report"
                                                        class="btn btn-primary"><?php echo $lang['btn-submit']; ?></button>
                                            </div>
                                            <?php
            ...
            <?php } ?>
                ...
                <p class="name">
                    ...
                    <?php if ($q->anonymous) {
                        ...
                        <b><a href="<?php echo $url_mapper['users/view'] . $q->user_id; ?>/"
                              style="color:black"><?php echo $user->f_name . " " . $user->l_name; ?></a>
                        </b><?php if ($user->last_seen >= (time() - 300000)) {
                        ...
                        <?php if ($q->user_id != $current_user->id && $current_user->can_see_this('users.follow', $group)) { ?>
                            ...
                            ?>
                            &nbsp;&nbsp;<a href="#me" class="btn btn-sm btn-default <?php echo $u_follow_class; ?>"
                                           name="<?php echo $user->id; ?>" value="<?php echo $q->follows; ?>"
                                           data-obj="User" data-lbl="<?php echo $lang['btn-follow']; ?>"
                            ...
                            <a href="#me" class="btn btn-sm btn-default open-chat"
                               data-user_id="<?php echo $user->id; ?>"><i
                                        class="fa fa-comments-o"></i> <?php echo $lang['index-chat-title']; ?></a>
                        <?php } ?>

                    <?php } ?>

                    <br>
                    <small style="color:#999"><?php if (!$q->anonymous) { ?> @<?php echo $user->username; ?> | <?php }
                ...
                if ($answers) {
                    foreach ($answers as $a) {
                        ...
                        if ($a->published == '1' || $a->published == '0' && $current_user->id == $a->user_id || $a->published == '0' && $current_user->prvlg_group == '1') {
                            ...
                            <?php if (isset($admanager1->msg) && $admanager1->msg != '' && $admanager1->msg != '&nbsp;') {
                                echo '<hr style="margin-bottom:5px">' . str_replace('\\', '', $admanager1->msg) . '<hr style="margin-top:5px">';
                            } else {
                                echo '<hr>';
                            } ?>
                            ...
                            <div class="question-element" id="answer-<?php echo $a->id; ?>">
                                <div class="publisher">
                                    <?php if ($a->published == 0) { ?><p class="label label-danger"><i
                                            class="fa fa-eye-slash"></i> <?php echo $lang['questions-pending-tag']; ?>
                                        </p><?php } ?>
                                    <img src="<?php echo $quser_avatar; ?>" class="img-circle"
                                         style="float:<?php echo $lang['direction-left']; ?>;width:46px;margin-<?php echo $lang['direction-right']; ?>:10px">
                                    <p class="name">
                                        <b><a href="<?php echo $url_mapper['users/view'] . $a->user_id; ?>/"><?php echo $user->f_name . " " . $user->l_name; ?></a></b><?php if ($user->last_seen >= (time() - 300000)) {
                                            echo "&nbsp;<i class='text-success fa fa-circle'></i>";
                                        } ?><?php if ($user->comment) {
                                            echo " " . $user->comment;
                                        } ?>
                                        ...
                                        <?php if ($a->user_id != $current_user->id && $current_user->can_see_this('users.follow', $group)) { ?>
                                            ...
                                            &nbsp;&nbsp;<a href="#me"
                                                           ...
                                                           value="<?php echo $user->follows; ?>" data-obj="User"
                                                           data-lbl="<?php echo $lang['btn-follow']; ?>"
                                                           data-lbl-active="<?php echo $lang['btn-followed']; ?>"><i
                                                        class="fa fa-user-plus"></i> <?php echo $follow_txt; ?>
                                                | <?php echo $user->follows; ?></a>
                                            <a href="#me" class="btn btn-sm btn-default open-chat"
                                               data-user_id="<?php echo $user->id; ?>"><i
                                                        class="fa fa-comments-o"></i> <?php echo $lang['index-chat-title']; ?>
                                            </a>
                                        <?php } ?>
                                        <br>
                                ...
                                <div class="btn-group question-like-machine">
                                    <a href="#me" class="btn btn-sm btn-default  answer_comment"
                                       data-answer_id="<?php echo $a->id; ?>"><i
                                                class="fa fa-comment"></i> <?php echo $lang['btn-reply']; ?></a>
                                    <?php if ($a->user_id != $current_user->id) { ?><a href="#me"
                                                                                       class="btn btn-sm btn-default <?php echo $upvote_class; ?>"
                                                                                       name="<?php echo $a->id; ?>"
                                                                                       value="<?php echo $a->likes; ?>"
                                                                                       data-obj="answer" data-lbl=""
                                                                                       data-lbl-active="" ><i
                                                class="fa fa-thumbs-o-up"></i> | <?php echo $a->likes; ?></a>
                                    <a href="#me" class="btn btn-sm btn-default <?php echo $downvote_class; ?>"
                                       name="<?php echo $a->id; ?>" value="<?php echo $a->dislikes; ?>"
                                       data-obj="answer" data-lbl="" data-lbl-active=""><i
                                                class="fa fa-thumbs-o-down"></i> | <?php echo $a->dislikes; ?>
                                        </a><?php } else { ?>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu"
                                            ...
                                            <?php if ($a->user_id == $current_user->id || $current_user->prvlg_group == '1') { ?>
                                                <?php if ($a->published == 0) { ?>
                                                    <?php if ($current_user->can_see_this('pending.update', $group)) { ?>
                                                        <li>
                                                            <a href="<?php echo $url_mapper['answers/approve'] . $url_type . "&type=approve_answer&id={$a->id}&hash={$random_hash}"; ?>">Approve
                                                                Answer</a></li>
                                                        <li role="separator" class="divider"></li>
                                                    <?php } ?>
                                                <?php } ?>
                                            ...
                                            <?php if (!$reported) { ?>
                                                <li><a href="#report-a-<?php echo $a->id; ?>"
                                                       data-toggle="modal"><?php echo $lang['questions-answer-report']; ?></a>
                                                </li>
                                            <?php } else { ?>
                                                <li style='color:#a0a0a0; text-align:center; padding:5px'><?php echo $lang['questions-report-reported']; ?></li>
                                            <?php } ?>
                                        ...
                                        <?php if (!$reported) { ?>
                                            <!-- Modal -->
                                            <div class="modal fade in" id="report-a-<?php echo $a->id; ?>" tabindex="-1"
                                                 role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="exampleModalLabel"><?php echo $lang['questions-answer-report']; ?></h5>
                                                        </div>
                                                        <form action="<?php echo $url_mapper['questions/view'];
                                                        echo $url_type; ?>" method="POST">
                                                            <div class="modal-body">
                                                                    ...
                                                                    <div class="flag_reasons clearfix">
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios1"
                                                                                       value="Harassment: Not respectful towards a person or group"
                                                                                       checked>
                                                                                <b>Harassment:</b> <span
                                                                                        class="light_gray">Not respectful towards a person or group</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios2"
                                                                                       value="Spam: Undisclosed promotion for a link or product">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios3"
                                                                                       value="Irrelevant: Does not address question that was asked">
                                                                                <b>Irrelevant:</b> <span
                                                                                        class="light_gray">Does not address question that was asked</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios4"
                                                                                       value="Plagiarism: Reusing content without attribution (link and blockquotes)">
                                                                                <b>Plagiarism:</b> <span
                                                                                        class="light_gray">Reusing content without attribution (link and blockquotes)</span></label>
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios5"
                                                                                       value="Joke Answer: Not a sincere answer">
                                                                                <b>Joke Answer:</b> <span
                                                                                        class="light_gray">Not a sincere answer</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios6"
                                                                                       value="Poorly Written: Bad formatting, grammar, and spelling">
                                                                                <b>Poorly Written:</b> <span
                                                                                        class="light_gray">Bad formatting, grammar, and spelling</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="info"
                                                                                       id="optionsRadios7"
                                                                                       value="Incorrect: Substantially incorrect and/or incorrect primary conclusions">
                                                                                <b>Incorrect:</b> <span
                                                                                        class="light_gray">Substantially incorrect and/or incorrect primary conclusions</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="answer-box-<?php echo $a->id; ?>"
                                    ...
                                    foreach ($sub_answers as $sa) {
                                        ...
                                        if ($sa->published == '1' || $sa->published == '0' && $current_user->id == $sa->user_id || $sa->published == '0' && $current_user->prvlg_group == '1') {
                                            ...
                                            <div class="question-element"
                                                 style="margin-<?php echo $lang['direction-left']; ?>: 50px"
                                                 id="answer-<?php echo $sa->id; ?>">
                                                <div class="publisher">
                                                    <?php if ($sa->published == 0) { ?><p class="label label-danger"><i
                                                            class="fa fa-eye-slash"></i> <?php echo $lang['questions-pending-tag']; ?>
                                                        </p><?php } ?>
                                                    <img src="<?php echo $quser_avatar; ?>" class="img-circle"
                                                         style="float:<?php echo $lang['direction-left']; ?>;width:46px;margin-<?php echo $lang['direction-right']; ?>:10px">
                                                    <p class="name">
                                                        <b><a href="<?php echo $url_mapper['users/view'] . $sa->user_id; ?>/"><?php echo $user->f_name . " " . $user->l_name; ?></a></b><?php if ($user->last_seen >= (time() - 300000)) {
                                                            echo "&nbsp;<i class='text-success fa fa-circle'></i>";
                                                        } ?><?php if ($user->comment) {
                                                            echo " " . $user->comment;
                                                        } ?>
                                                        ...
                                                        <br>
                                                        <small>@<?php echo $user->username; ?>
                                                            | <?php if ($sa->updated_at != "0000-00-00 00:00:00") {
                                                                echo $lang['index-question-updated'] . ' ' . date_ago($sa->updated_at);
                                                            } else {
                                                                echo $lang['index-question-created'] . ' ' . date_ago($sa->created_at);
                                                            } ?></small>
                                                    </p>
                                                </div>
                                                <br>
                                                ...
                                                <div class="btn-group question-like-machine">
                                                    ...
                                                    <?php if ($sa->user_id != $current_user->id) { ?><a href="#me"
                                                                                                        class="btn btn-sm btn-default <?php echo $upvote_class; ?>"
                                                                                                        name="<?php echo $sa->id; ?>"
                                                                                                        value="<?php echo $sa->likes; ?>"
                                                                                                        data-obj="answer"
                                                                                                        data-lbl=""
                                                                                                        data-lbl-active="" >
                                                        <i class="fa fa-thumbs-o-up"></i> | <?php echo $sa->likes; ?>
                                                        </a>
                                                    <a href="#me"
                                                       class="btn btn-sm btn-default <?php echo $downvote_class; ?>"
                                                       name="<?php echo $sa->id; ?>"
                                                       value="<?php echo $sa->dislikes; ?>" data-obj="answer"
                                                       data-lbl="" data-lbl-active=""><i
                                                                class="fa fa-thumbs-o-down"></i>
                                                        | <?php echo $sa->dislikes; ?></a><?php } else { ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu"
                                                            ...
                                                            <?php if ($sa->user_id == $current_user->id || $current_user->prvlg_group == '1') { ?>
                                                                <?php if ($sa->published == 0) { ?>
                                                                    <?php if ($current_user->can_see_this('pending.update', $group)) { ?>
                                                                        <li>
                                                                            <a href="<?php echo $url_mapper['answers/approve'] . $url_type . "&type=approve_answer&id={$sa->id}&hash={$random_hash}"; ?>">Approve
                                                                                Answer</a></li>
                                                                        <li role="separator" class="divider"></li>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                                ...
                                                                <?php if ($current_user->can_see_this('answers.update', $group)) { ?>
                                                                    <li>
                                                                    <a href="<?php echo $url_mapper['answers/edit'] . $url_type; ?>&type=edit_answer&id=<?php echo $sa->id; ?>&hash=<?php echo $random_hash; ?>#answer-question">Edit</a>
                                                                    </li><?php } ?>
                                                                <?php if ($current_user->can_see_this('answers.delete', $group)) { ?>
                                                                    <li>
                                                                    <a href="<?php echo $url_mapper['answers/delete'] . $url_type; ?>&type=delete_answer&id=<?php echo $sa->id; ?>&hash=<?php echo $random_hash; ?>"
                                                                       onclick="return confirm('Are you sure you want to delete this answer?');">Delete</a>
                                                                    </li><?php } ?>
                                                            ...
                                                            <?php if (!$reported) { ?>
                                                                <li><a href="#report-a-<?php echo $sa->id; ?>"
                                                                       data-toggle="modal"><?php echo $lang['questions-answer-report']; ?></a>
                                                                </li>
                                                            <?php } else { ?>
                                                                <li style='color:#a0a0a0; text-align:center; padding:5px'><?php echo $lang['questions-report-reported']; ?></li>
                                                        ...
                                                        <?php if (!$reported) { ?>
                                                            ...
                                                            <div class="modal fade in"
                                                                 id="report-a-<?php echo $sa->id; ?>" tabindex="-1"
                                                                                        ...
                                                                                        <div class="radio">
                                                                                            <label>
                                                                                                <input type="radio"
                                                                                                       ...
                                                                                                       value="Spam: Undisclosed promotion for a link or product">
                                                                                                <b>Spam:</b> <span
                                                                                                        class="light_gray">Undisclosed promotion for a link or product</span>
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="radio">
                                                                                            <label>
                                                                                        ...
                                                                                        <div class="radio">
                                                                                            <label>
                                                                                                <input type="radio"
                                                                                                       ...
                                                                                                       value="Joke Answer: Not a sincere answer">
                                                                                                <b>Joke Answer:</b>
                                                                                                <span class="light_gray">Not a sincere answer</span>
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="radio">
                                                                                            <label>
                                                                                                <input type="radio"
                                                                                                       ...
                                                                                                       value="Poorly Written: Bad formatting, grammar, and spelling">
                                                                                                <b>Poorly Written:</b>
                                                                                                <span class="light_gray">Bad formatting, grammar, and spelling</span>
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="radio">
                                                                                            <label>
                ...
                if ($current_user->id == 1000) {
                    ...
                    <div class="col-md-12" style='margin-top:-100px;padding:0'>
                        <a href="<?php echo $url_mapper['login/']; ?>"><img
                                    src="<?php echo WEB_LINK; ?>/public/img/login-notice.png" style='width:100%'></a>
                ...
                <?php if ($current_user->can_see_this("answers.create", $group)) { ?>
                    ...
                    <form action="<?php echo $url_mapper['questions/view'] . $url_type; ?>" method="post" role="form"
                            ...
                            <div class="share">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="">
                            <textarea name="title" cols="40" rows="10" class="summernote"
                                      style="height: 62px; overflow: hidden;" placeholder="What's on your mind ?"
                                      required>
							<?php if (isset($edit_answer_mode)) {
                                echo str_replace('\\', '', $edited_answer->content);
                            } ?>
							</textarea>
                                        </div>
                                    </div>
                                    <div class="panel-footer">
                                        <div class="form-group">
                                            <?php if (isset($edit_answer_mode)) {
                                                $answer_value = $lang['questions-answer-update'];
                                            } else {
                                                $answer_value = $lang['questions-answer-create'];
                                            } ?>
                                            <input type="submit" name="add_a" value="<?php echo $answer_value; ?>"
                                                   style="" class="btn btn-default">
                                            <?php
                                            $_SESSION[$elhash] = $random_hash;
                                            if (isset($edit_answer_mode)) {
                                                echo "<input type=\"hidden\" name=\"edit_id\" value=\"" . $edited_answer->id . "\" readonly/>";
                                            }
                                            echo "<input type=\"hidden\" name=\"hash\" value=\"" . $random_hash . "\" readonly/>";
                                            ?>
                                        </div>
            ...
            <div class="col-md-3 visible-sm visible-xs">
                ...
                <ul class="feed-ul">
                    ...
                    <li><a href="<?php echo $url_mapper['index/']; ?>"
                           class="<?php echo $current; ?> col-xs-12"><?php echo $lang['index-sidebar-top']; ?></a></li>
                    <li>&nbsp;</li>
                    ...
                    if ($tags) {
                        foreach ($tags as $tag) {
                            ...
                            ?>
                            <li><a href="<?php echo $url_mapper['feed/'] . $tag->name; ?>"
                                   class="<?php echo $current; ?> col-xs-12"><?php echo $tag->name; ?></a></li>
                            <?php
                        }
                    }
                    ?>
                ...
                <?php if (isset($admanager2->value) && $admanager2->value != '' && $admanager2->value != '&nbsp;') {
                    echo '<br style="clear:both"><hr>' . str_replace('\\', '', $admanager2->value);
                } ?>
            ...
            <div class="col-md-3 hidden-sm hidden-xs">
                ...
                <hr>
                <ul class="feed-ul">
                    <li><a href="<?php echo $url_mapper['pages/view']; ?>about_us"
                           class="col-md-12"><?php echo $lang['pages-about-title']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['pages/view']; ?>contact_us"
                           class="col-md-12"><?php echo $lang['pages-contact-title']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['pages/view']; ?>privacy_policy"
                           class="col-md-12"><?php echo $lang['pages-privacy-title']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['pages/view']; ?>terms"
                           class="col-md-12"><?php echo $lang['pages-terms-title']; ?></a></li>
                    <li><a href="<?php echo $url_mapper['leaderboard/']; ?>"
                           class="col-md-12"><?php echo $lang['pages-leaderboard-title']; ?></a></li>
                </ul>
                <?php if (isset($admanager2->msg) && $admanager2->msg != '' && $admanager2->msg != '&nbsp;') {
                    echo "<br style='clear:both'><hr>" . str_replace('\\', '', $admanager2->msg) . "<hr><br style='clear:both'>";
                } else {
                ...
                <ul class="feed-ul">
                    ...
                    if ($questions) {
                        foreach ($questions as $q) {
                            ...
                            ?>
                            <li><a href="<?php echo $url_mapper['questions/view'];
                                echo $url_type2; ?>" class="col-md-12"><?php echo $string; ?></a></li>
                            <?php
                        }
                    }
                    ?>
                    ...
                    <ul class="feed-ul">
                        ...
                        if ($questions) {
                            ...
                            if ($total_count > 5) {
                                ?>
                                <li>
                                    <a href="<?php echo $url_mapper['users/view'] . $current_user->id ?>/?section=questions"
                                       class="col-md-12">View +<?php echo($total_count - 5); ?> more</a></li>
                                <?php
                            }
                        }
                        ?>
                    ...
                    <ul class="feed-ul">
                        ...
                        if ($answers) {
                            foreach ($answers as $a) {
                                ...
                                ?>
                                <li><a href="<?php echo $url_mapper['questions/view'];
                                    echo $url_type2; ?>#answer-<?php echo $a->id; ?>"
                                       class="col-md-12"><?php echo $string; ?></a></li>
                                <?php
                            }
                            if ($total_count > 5) {
                                ?>
                                <li>
                                    <a href="<?php echo $url_mapper['users/view'] . $current_user->id ?>/?section=answers"
                                       class="col-md-12">View +<?php echo($total_count - 5); ?> more</a></li>
                                <?php
                            }
                        }
